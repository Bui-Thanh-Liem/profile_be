...
import { AResponseBase, AResponseError } from 'src/abstracts/ABaseResponse.abstract';
...
export class ResponseError extends AResponseError {
  constructor(path: string, method: string, message: string, statusCode: HttpStatus) {
