...
export class CustomerService {
  ...
  async verifyRegister({ payload, active }: ICreateService<VerifyRegisterDto>): Promise<boolean> {
  ...
  async findAll({ queries, active }: IFindAllService<CustomerEntity>): Promise<IGetMulti<CustomerEntity>> {
    //
